...
class OrganOyunu extends StatefulWidget {
  const OrganOyunu({super.key});

  @override
  State<OrganOyunu> createState() => _OrganOyunuState();
}

class _OrganOyunuState extends State<OrganOyunu> with SingleTickerProviderStateMixin {
  ...
  void oyunuKur() {
    setState(() {
      hedef = Random().nextInt(organlar.length);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Organları Tanı", style: Sabitler.baslikStili),
        centerTitle: true,
